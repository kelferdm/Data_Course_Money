...
df = read.csv("../Data_Course/Data/landdata-states.csv") # why did I change to read.csv ???
class(df) # what type of object is df? data.frame
head(df) # shows the first 6 elements of an object (first 6 rows if you give it a data frame) 1:6
```
...
**Questions:**
  ...
  separates columns based on semi-colons instead of commas
